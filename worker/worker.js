...
const MODELS = ["gemini-flash-latest", "gemini-3.5-flash", "gemini-3.5-flash-lite", "gemini-flash-lite-latest", "gemini-3.1-flash-lite"];
...
export default {
  async fetch(req, env) {
    ...
    if (req.method !== "POST") return json({ ok: true, msg: "세금노트 챗봇 서버 작동 중" }, 200, origin);
